...
public interface ProductRepository extends JpaRepository<Product,Long>{
    ...
    //@Query("SELECT DISTINCT u.username FROM Product p LEFT OUTER JOIN p.userperson u WHERE p.dateOfPurchase BETWEEN '2022-12-27 05:30:00' AND '2023-01-03 05:30:00'")
    //@Query("SELECT p.dateOfPurchase FROM Product p LEFT OUTER JOIN p.userperson u")
